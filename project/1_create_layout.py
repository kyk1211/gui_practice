...
cmb_space = ttk.Combobox(frame_option, state = 'readonly', values=opt_width, width = 10)
cmb_space.current(0)
...
cmb_format = ttk.Combobox(frame_option, state = 'readonly', values=opt_width, width = 10)
